...
namespace FinalProject.Controllers
{
    ...
    public class SportsController : ControllerBase
    {
        ...
        // UPDATE
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, Sports updatedSport)
        {
            var sport = await _context.Sports.FindAsync(id);
            ...
            sport.Sport = updatedSport.Sport;
            sport.Team = updatedSport.Team;
            sport.Wins = updatedSport.Wins;
